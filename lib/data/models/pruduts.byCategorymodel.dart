...
List<ProductsByCategoryModel> productsByCategoryModelFromJson(String str) =>
    List<ProductsByCategoryModel>.from(
      json.decode(str).map((x) => ProductsByCategoryModel.fromJson(x)),
    );
...
class ProductsByCategoryModel {
  ...
  ProductsByCategoryModelType? type;
  Status? status;
  bool? featured;
  ...
  factory ProductsByCategoryModel.fromJson(
    ...
    type:
        json["type"] == null
            ? null
            : productsByCategoryModelTypeValues.map[json["type"]],
    status: json["status"] == null ? null : statusValues.map[json["status"]],
    featured: json["featured"],
    catalogVisibility:
        json["catalog_visibility"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
    ...
    "type":
        type == null ? null : productsByCategoryModelTypeValues.reverse[type],
    ...
    "parent_id": parentId,
    "purchase_note":
        purchaseNote == null ? null : purchaseNoteValues.reverse[purchaseNote],
    "categories":
        categories == null
            ? null
    ...
    "stock_status":
        stockStatus == null ? null : stockStatusValues.reverse[stockStatus],
...
class Download {
  ...
  factory Download.fromJson(Map<String, dynamic> json) =>
      Download(id: json["id"], name: json["name"], file: json["file"]);
...
class Links {
  ...
  Map<String, dynamic> toJson() => {
    "self":
        self == null ? null : List<dynamic>.from(self!.map((x) => x.toJson())),
    "collection":
        collection == null
            ? null
...
class TargetHints {
  ...
  factory TargetHints.fromJson(Map<String, dynamic> json) => TargetHints(
    allow:
        json["allow"] == null
            ? null
            : List<Allow>.from(json["allow"].map((x) => allowValues.map[x]!)),
  );
...
enum ProductsByCategoryModelType { SIMPLE }

final productsByCategoryModelTypeValues = EnumValues({
  "simple": ProductsByCategoryModelType.SIMPLE,
});
...
class YoastHeadJson {
  ...
  factory YoastHeadJson.fromJson(Map<String, dynamic> json) => YoastHeadJson(
    ...
    ogType: json["og_type"] == null ? null : ogTypeValues.map[json["og_type"]],
    ogTitle: json["og_title"],
    ogDescription: json["og_description"],
    ogUrl: json["og_url"],
    ogSiteName:
        json["og_site_name"] == null
            ? null
            : ogSiteNameValues.map[json["og_site_name"]],
    articleModifiedTime:
        json["article_modified_time"] == null
            ? null
    ...
    twitterCard:
        json["twitter_card"] == null
            ? null
            : twitterCardValues.map[json["twitter_card"]],
    twitterMisc:
        json["twitter_misc"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
    ...
    "og_url": ogUrl,
    "og_site_name":
        ogSiteName == null ? null : ogSiteNameValues.reverse[ogSiteName],
    ...
    "twitter_card":
        twitterCard == null ? null : twitterCardValues.reverse[twitterCard],
...
class OgImage {
  ...
  factory OgImage.fromJson(Map<String, dynamic> json) => OgImage(
    ...
    height: json["height"],
    url: json["url"],
    type: json["type"] == null ? null : ogImageTypeValues.map[json["type"]],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "height": height,
    "url": url,
    "type": type == null ? null : ogImageTypeValues.reverse[type],
  };
}

enum OgImageType { IMAGE_JPEG, IMAGE_PNG, IMAGE_WEBP }
...
class Robots {
  ...
  factory Robots.fromJson(Map<String, dynamic> json) => Robots(
    index: json["index"] == null ? null : indexValues.map[json["index"]],
    follow: json["follow"] == null ? null : followValues.map[json["follow"]],
    maxSnippet:
        json["max-snippet"] == null
            ? null
            : maxSnippetValues.map[json["max-snippet"]],
    maxImagePreview:
        json["max-image-preview"] == null
            ? null
            : maxImagePreviewValues.map[json["max-image-preview"]],
    maxVideoPreview:
        json["max-video-preview"] == null
            ? null
...
class Schema {
  ...
  factory Schema.fromJson(Map<String, dynamic> json) =>
      Schema(context: json["@context"]);

  Map<String, dynamic> toJson() => {"@context": context};
}
...
class Graph {
  ...
  factory Graph.fromJson(Map<String, dynamic> json) => Graph(
    ...
    name: json["name"],
    isPartOf:
        json["isPartOf"] == null ? null : Breadcrumb.fromJson(json["isPartOf"]),
    primaryImageOfPage:
        json["primaryImageOfPage"] == null
            ? null
    ...
    inLanguage:
        json["inLanguage"] == null
            ? null
            : inLanguageValues.map[json["inLanguage"]],
    potentialAction:
        json["potentialAction"] == null
            ? null
...
class QueryInput {
  ...
  factory QueryInput.fromJson(Map<String, dynamic> json) => QueryInput(
    type:
        json["@type"] == null ? null : queryInputTypeValues.map[json["@type"]],
...
class TargetClass {
  ...
  TargetClass({this.type, this.urlTemplate});

  factory TargetClass.fromJson(Map<String, dynamic> json) => TargetClass(
    type: json["@type"] == null ? null : targetTypeValues.map[json["@type"]],
    urlTemplate:
        json["urlTemplate"] == null
            ? null
...
class TwitterMisc {
  ...
  factory TwitterMisc.fromJson(Map<String, dynamic> json) =>
      TwitterMisc(estReadingTime: json["Est. reading time"]);

  Map<String, dynamic> toJson() => {"Est. reading time": estReadingTime};
}
