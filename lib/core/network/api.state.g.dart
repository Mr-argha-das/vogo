...
class _APIStateNetwork implements APIStateNetwork {
  ...
  @override
  Future<HttpResponse<RegisterResponse>> register(RegisterRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<ForgotresModel>> forgot(ForgotbodyModel body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<HttpResponse<ForgotresModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/vogofamily/forgot',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ForgotresModel _value;
    try {
      _value = ForgotresModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
